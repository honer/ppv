...
public class Command {
   ...
   // 當主伺服器的客戶端 
   public static String Main_Server_Ip = "192.168.1.223";
 ...
 //  public static boolean read_lock_flag = false; // 此為資料讀取的栓鎖旗標,為了防止讀取的資料被其他的程序讀去
   ...
   public static String[] list1 = null; // 存放選單1的資料
   public static String[] list2 = null; // 存放選單2的資料\
   ...
   public static int[] Port_Of_Proxy; // 每個代理伺服器的Port
    ...
    public static String suport_path = "D:\\suport"; // 存放檔案和支援檔案的位置
